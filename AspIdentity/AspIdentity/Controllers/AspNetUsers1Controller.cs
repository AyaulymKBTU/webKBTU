...
{
    public class AspNetUsers1Controller : ApiController
    {
        private AspIdentityEntities2 db = new AspIdentityEntities2();

        // GET: api/AspNetUsers1
